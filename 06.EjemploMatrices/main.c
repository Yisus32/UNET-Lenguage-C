/*
*tile: Matrices
*description: En esta lección aprenderemos a trabajar con la lectura y escritura de matrices (arreglos bidimencionales) usando ciclos
*author: Jesus Altuve
*/
...
int main()
{
    ...
    //Lectura de datos est�ticos de una matriz
